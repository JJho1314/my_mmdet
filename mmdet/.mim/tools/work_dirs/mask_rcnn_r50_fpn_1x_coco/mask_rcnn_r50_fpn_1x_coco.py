...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/data/zy_data/coco/annotations/instances_train2017.json',
        img_prefix='/data/zy_data/coco/train2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/data/zy_data/coco/annotations/instances_val2017.json',
        img_prefix='/data/zy_data/coco/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
